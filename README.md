...
**Реализован механизм скриншотов при падении тестов.**

Автоматическое сохранение скриншотов демонстрируется на модуле авторизации. При  падении тестов в классе `IntershopAuthTests.java` скриншиты сохраняются автоматически.

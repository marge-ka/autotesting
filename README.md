...
**Реализован механизм скриншотов при падении тестов (демонстрируется на модуле авторизации).**
При  падении тестов в классе `IntershopAuthTests.java`, скриншиты сохраняются автоматически.
